...
case class ParseJson(child: Expression) extends UnaryExpression
  ...
  protected override def nullSafeEval(input: Any): Any = {
    try {
      ...
      case _: VariantSizeLimitException => throw QueryExecutionErrors.variantSizeLimitError()
      case NonFatal(e) => throw QueryExecutionErrors.malformedRecordsDetectedInRecordParsingError(
